  ...
  return (
    <div className="flex">
      <div className="flex-1 max-w-4xl mx-auto px-6 py-12">
        ...
        <h1
          id="welcome"
          className="text-5xl font-bold mb-4 text-gray-900 dark:text-gray-100 scroll-mt-20"
        >
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
            Pawn Appétit is a modern, free, and open-source chess GUI (Graphical User Interface)
            designed to provide professional-grade chess analysis tools without the hefty price tag.
            Built with Rust and Tauri, it offers exceptional performance while maintaining a
            ...
            {[
              {
                ...
                description:
                  "Deep engine analysis with support for multiple UCI engines including Stockfish.",
              },
              {
