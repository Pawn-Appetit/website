      ...
      <div className="flex-1 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-8">
            <li>
              <strong>OS:</strong> Windows 10+, macOS 10.15+, or Linux (Ubuntu 20.04+)
            </li>
            <li>
              <strong>RAM:</strong> 4GB minimum (8GB recommended)
            </li>
            <li>
              <strong>Storage:</strong> 500MB for the application
            </li>
            <li>
              <strong>Display:</strong> 1280x720 minimum resolution
            </li>
          </ul>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 mb-6">
            <li>
              Download the latest <code>.msi</code> installer from the releases page
            </li>
          ...
          <a
            href="https://github.com/Pawn-Appetit/pawn-appetit/releases/download/v0.12.1/Pawn.Appetit_0.12.1_x64-setup.exe"
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 mb-6">
            <li>
              Download the <code>.dmg</code> file from the releases page
            </li>
          ...
          <a
            href="https://github.com/Pawn-Appetit/pawn-appetit/releases/download/v0.12.1/Pawn.Appetit_0.12.1_x64.dmg"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors mb-6"
          >
            <Download className="w-5 h-5" />
            Download for macOS
          ...
          <Callout type="warning" title="macOS Security">
            On first launch, macOS may show a security warning. Right-click the app and select
            &quot;Open&quot; to bypass Gatekeeper, or go to System Preferences → Security & Privacy
            to allow the app.
          </Callout>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 mb-6">
            <li>
              Download the Linux <code>.AppImage</code> or <code>.deb</code> file
            </li>
          ...
          <a
            href="https://github.com/Pawn-Appetit/pawn-appetit/releases/download/v0.12.1/Pawn.Appetit_0.12.1_amd64.AppImage"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors mb-6"
          >
            <Download className="w-5 h-5" />
            Download for Linux
                ...
                {buildFromSource.steps.map((step, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <CopyButton text={step.command} className="p-1.5" />
                    </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    ...
                    for development with hot reload. The production build will be available in
          ...
          <Callout type="tip" title="Next Steps">
            Now that Pawn Appétit is installed, head over to the First Steps guide to learn how to
            set up your chess engines and start analyzing games!
          </Callout>
        </div>
