    ...
    <div className="flex">
      <div className="flex-1 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <a
            href="https://github.com/Pawn-Appetit/pawn-appetit/releases/download/v0.11.0/Pawn.Appetit_0.11.0_x64-setup.exe"
          ...
          <a
            href="https://github.com/Pawn-Appetit/pawn-appetit/releases/download/v0.11.0/Pawn.Appetit_0.11.0_x64.dmg"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors mb-6"
          >
            <Download className="w-5 h-5" />
            Download for macOS
          ...
          <a
            href="https://github.com/Pawn-Appetit/pawn-appetit/releases/download/v0.11.0/Pawn.Appetit_0.11.0_amd64.AppImage"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors mb-6"
          >
            <Download className="w-5 h-5" />
            Download for Linux
