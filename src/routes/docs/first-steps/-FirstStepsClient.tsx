...
export default function FirstStepsClient() {
  const tocItems = [
    ...
    <div className="flex">
      <div className="flex-1 max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
          Get started with Pawn Appétit by setting up your chess engine, database, and importing
          your games.
        </p>
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h2
            id="install-engine"
            className="text-3xl font-bold mb-4 scroll-mt-20 flex items-center gap-3"
          >
            <Settings className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            Install Chess Engine
          </h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            A chess engine is essential for analyzing your games. Pawn Appétit supports any
            UCI-compatible engine, with Stockfish being the most popular choice.
          </p>
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
            <li>
              Navigate to <strong>Engines</strong>
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                <li>
                  <strong>Threads:</strong> Set to the number of CPU cores (typically 4-8)
                </li>
                <li>
                  <strong>Hash:</strong> Set memory allocation (1024-4096 MB recommended)
                </li>
                <li>
                  <strong>MultiPV:</strong> Number of best moves to show (1-3 recommended)
                </li>
              </ul>
            </li>
          </ol>
          ...
          <Callout type="info" title="Engine Performance">
            Higher thread count and hash size improve engine performance but use more system
            resources. Start with conservative values and adjust based on your computer&apos;s
            capabilities.
          </Callout>

          <h2
            id="add-database"
            className="text-3xl font-bold mb-4 mt-12 scroll-mt-20 flex items-center gap-3"
          >
            <Database className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            Add a Database
          </h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            Databases in Pawn Appétit store your games, opening preparations, and analysis. You can
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
            <li>
              Navigate to <strong>Databases</strong>
            </li>
            <li>
              Click on <strong>Add New</strong>
            </li>
          ...
          <Callout type="tip" title="Database Organization">
            Consider creating separate databases for different purposes: tournament games, training
            games, opening preparation, and opponent analysis.
          </Callout>
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            Connect your Chess.com or Lichess account to automatically import your online games and
            track your progress.
          </p>
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
            ...
            <li>
              Click <strong>Add Account</strong> and select <strong>Chess.com</strong>
            </li>
          ...
          <Callout type="info" title="Chess.com API">
            Chess.com provides a public API that doesn&apos;t require authentication. Simply enter
            your username to access your games. Make sure your game archive is public in your
            Chess.com settings.
          </Callout>
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
            ...
            <li>
              Click <strong>Add Account</strong> and select <strong>Lichess</strong>
            </li>
          ...
          <Callout type="tip" title="Need Help?">
            If you encounter any issues during setup, check out our FAQ section or join our
            community Discord server for support and tips from other users.
          </Callout>
        </div>
