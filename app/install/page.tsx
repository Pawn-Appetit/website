    ...
    const platforms = [
        {
            ...
            downloadUrl: 'https://github.com/Pawn-Appetit/pawn-appetit/releases/latest/download/Pawn.Appetit_0.7.2_x64-setup.exe',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/Pawn-Appetit/pawn-appetit/releases/latest/download/Pawn.Appetit_0.7.2_x64.dmg',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/Pawn-Appetit/pawn-appetit/releases/latest/download/Pawn.Appetit_0.7.2_amd64.AppImage',
            instructions: [
